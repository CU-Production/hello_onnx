...
//    config.SafetyModelPath     = L"E:/workspace/ML/sd1.5onnx/stable-diffusion-v1-5/safety_checker/model.onnx";
    ...
    config.TextEncoderOnnxPath = L"E:/SW/ML/stable-diffusion-1.5-onnx/text_encoder/model.onnx";
    config.UnetOnnxPath        = L"E:/SW/ML/stable-diffusion-1.5-onnx/unet/model.onnx";
    config.VaeDecoderOnnxPath  = L"E:/SW/ML/stable-diffusion-1.5-onnx/vae_decoder/model.onnx";
    config.SafetyModelPath     = L"E:/SW/ML/stable-diffusion-1.5-onnx/safety_checker/model.onnx";
